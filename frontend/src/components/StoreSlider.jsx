                            ...
                            {leftGames.map((game, index) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`block w-full rounded-md overflow-hidden  bg-black/40 transition-all duration-300 ${isActive ? 'ring-2 ring-white scale-105 z-10 relative opacity-100' : 'hover:scale-[1.02] opacity-50'}`}
